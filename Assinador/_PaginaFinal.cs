...
namespace CMP.ManipuladorPDF
{
    ...
    {
        private static MemoryStream PaginaFinal(PdfReader pdfReader)
        {
            ...
            string documentName = "NOME DO DOCUMENTO";
                ...
                <div id=""footer"">
                    ...
                    <div id=""info"">
                        <p>
                            ...
                            ou acesse <b><a href=""https://validacao.camarapiracicaba.sp.gov.br"">https://validacao.camarapiracicaba.sp.gov.br</a></b> e informe o código <b>XOXOXO</b>
                        </p>
                    </div>
                </div>
            ";
            ...
            paginaFinal.CopyPagesTo(1,paginaFinal.GetNumberOfPages(), newPdfDoc);
            paginaFinal.Close();
            return outputStream;
        }

        public static MemoryStream AdicionarPaginaFinal(
          this MemoryStream sourceFile
        ) {
            MemoryStream _stream = PaginaFinal(new PdfReader(sourceFile));
