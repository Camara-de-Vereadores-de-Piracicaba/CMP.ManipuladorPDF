...
namespace CMP.ManipuladorPDF
{
    ...
    {
        public static Certificado2 AbrirCertificado(
            Stream certificado,
            string senha
        )
        {
        ...
        */
        ...
        public static Certificado2 ObterCertificado(string certificado, string senha)
        {
            return AbrirCertificado(new FileStream(certificado, FileMode.Open, FileAccess.Read),senha);
        }

        public static Certificado2 ObterCertificado(byte[] certificado, string senha)
        {
